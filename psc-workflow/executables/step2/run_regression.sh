...
python3 run_regression.py --mode train --is_pretrained_checkpoint --checkpoint_path pretrain_OCELOT/pretrain_MS_0.0001/model_pretrain/checkpoint_3000.mdl --params ${ENTRY_LOCATION}/regression_params.yaml --model_dir ${ENTRY_LOCATION}/regression_OCELOT/ms_OCELOT