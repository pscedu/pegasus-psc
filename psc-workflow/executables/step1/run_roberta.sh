...
tar cvzf pretrain_OCELOT__pretrain_MS_0_0001__model_pretrain.tgz --directory=${ENTRY_LOCATION}/ pretrain_OCELOT/pretrain_MS_0.0001/model_pretrain/checkpoint_3000.mdl