...
#SBATCH -A sys890003p
#SBATCH --output=regression_data_pah101_ms_%j.out
...
python create_regression_csv_new.py --data_dir /ocean/projects/sys890003p/spagaria/project1/dana/Merged_Dataset/DF --encoding materials_string --outdir /ocean/projects/sys890003p/spagaria/project1/dana/regression_density --train_val_split 0.8